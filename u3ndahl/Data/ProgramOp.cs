...
namespace u3ndahl.Data
{
    public class ProgramOp
    {
        ...
        private List<Program> programs = new List<Program>
            {
                //Kanal 1
                new Program {id=1, title="Go' middag!", category ="Serie", channel=1, length=60, date= new DateTime(2017,11,29, 17,00,00), description="......" },
                ...
                //Kanal 2
                new Program {id=1, title="----", category ="Serie", channel=2, length=30, date= new DateTime(2017,11,29, 17,30,00), description="......" },
                ...
                new Program {id=1, title="----", category ="Serie", channel=3, length=30, date= new DateTime(2017,11,29, 17,30,00), description="......" },
                ...
                //Kanal 4
                new Program {id=1, title="----", category ="Serie", channel=4, length=30, date= new DateTime(2017,11,29, 17,30,00), description="......" },
